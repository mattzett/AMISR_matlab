...
function [vest,Pvest,x2,y2,A2] = vfield_holistic(vlos,dvlos,xgmag,ygmag,K,Nx,Ny,alpha)
...
%             if x > 1,
%                 % left
%                 neighbors = [neighbors, Nx*(x-2)+y];
%             end;
%             if x < Ny,
%                 % right
%                 neighbors = [neighbors, Nx*x+y];
%             end;
%             if y > 1,
%                 % top
%                 neighbors = [neighbors, Nx*(x-1)+y-1];
%             end;
%             if y < Nx,
%                 % bottom
%                 neighbors = [neighbors, Nx*(x-1)+y+1];
...
%                 B(Nx*(x-1)+y,neighbors) = 1;
%                 B(Nx*(x-1)+y,Nx*(x-1)+y) = -4;
% %             end;
