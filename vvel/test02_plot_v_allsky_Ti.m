%-------------------------------------------------------------------------%
% Test 2: Plot the recovered vector velocity field superimposed over the
% corresponding section of allsky image.  Also plot the temperature as a
% contour plot.  Data from 24 March 2009
% 
% Thomas Butler
% 12 May 2009
%
...
%-----------------------------&
load /shared/classes/projects/AMISR-experiments/data/20090324_Allsky/UnwarpedImages
...
%         axis equal
    ...
    if output,
        outfilename = sprintf('%s/arc_%03d',outputdir,ti);
