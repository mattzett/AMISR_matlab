% VFIELD_HOLISTIC_INCOMPRESSIBLE_altBC
%
% Usage:
%   [vest,Pvest] = vfield_holistic_incompressible_altBC(vlos,dvlos,xgmag,ygmag,K,Nx,Ny,alpha)
%
% Inputs:
...
function [vest,Pvest,x2,y2,A2] = vfield_holistic_incompressible_altBC(vlos,dvlos,xgmag,ygmag,K,Nx,Ny,alpha)
